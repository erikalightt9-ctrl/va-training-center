    ...
    <div className="min-h-screen bg-[#0f1623] text-white p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            Track and manage all revenue records
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-[#1a2535] rounded-xl p-5 border border-[#243047]">
          ...
          <p className="text-xs text-gray-500 mt-1">All time, excluding refunds</p>
        </div>
        <div className="bg-[#1a2535] rounded-xl p-5 border border-[#243047]">
          <div className="flex items-center justify-between mb-3">
          ...
          <p className="text-2xl font-bold text-white">
            {formatAmount(thisMonthTotal, "PHP")}
          </p>
          <p className="text-xs text-gray-500 mt-1">{thisMonth.length} records</p>
        </div>
        <div className="bg-[#1a2535] rounded-xl p-5 border border-[#243047]">
          <div className="flex items-center justify-between mb-3">
