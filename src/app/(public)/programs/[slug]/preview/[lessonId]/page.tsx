...
export const metadata: Metadata = { title: "Free Lesson Preview | HUMI+ VA Training Center" };
            ...
            <div className="sticky top-8">
              <div className="bg-gray-50 rounded-xl border border-gray-200 p-5">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  {course.title} &middot; {curriculum.length} lessons
                </p>
                  ...
                  {curriculum.map((item) => {
                    ...
                    return (
                      <div key={item.id}>
                        {isFree ? (
                          <Link
                            href={`/programs/${courseSlugPath}/preview/${item.id}`}
                ...
                <div className="mt-5 pt-4 border-t border-gray-200">
                  ...
                  <p className="text-[11px] text-gray-400 text-center mt-2">
                    {"\u20B1"}{parseFloat(course.price.toString()).toLocaleString()} &middot; {course.durationWeeks}-week program
                  </p>
                </div>
              </div>
            </div>
